...
$stmt = $con->prepare("SELECT * FROM room_types");
$stmt->execute();
$room_types = $stmt->fetchAll();

foreach($room_types as $room_type) {
    $room_image = "admin/Uploads/images/".$room_offer['brand_image'];
    ?>
    <div class="col-md-4">
        <div class="room_offers" style="background-image: url(<?php echo $room_image; ?>);">
            <div class="brand_name">
                <h3>
                    <?php echo $room_offer['brand_name']; ?>
                </h3>
            </div>
        </div>
    </div>
